 ...
 */
    ...
    public override func viewDidLoad() {
        ...
        self.contentCoverView.frame = CGRectMake(0 , 0, self.view.frame.width, UIScreen.mainScreen().bounds.height)
        UIApplication.sharedApplication().statusBarStyle = .LightContent

        
        //self.contentCoverView.frame = (self.sideViewController?.view.bounds)!
        self.contentCoverView.backgroundColor = self.topViewControllerDimColor
