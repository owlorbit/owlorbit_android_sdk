...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods/ALThreeCircleSpinner.framework"
  ...
  install_framework "Pods/CKCircleMenuView.framework"
  ...
  install_framework "Pods/ImageCropView.framework"
