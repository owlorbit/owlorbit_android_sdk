...
class CoreDataHelper{
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        //let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Sift-" + NSBundle.mainBundle().releaseVersionNumber! + ".sqlite")
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("SiftCore-" + ProjectConstants.CoreData.version + ".sqlite")
